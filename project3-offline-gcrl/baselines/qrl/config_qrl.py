...
_ENV_CONFIGS = {
    ...
    "cube-single-play-v0":    dict(alpha=0.3, train_steps=1000000),
    "cube-double-play-v0":    dict(alpha=0.3, train_steps=1000000),
    "cube-triple-play-v0":    dict(alpha=0.3, train_steps=1000000),
    "cube-quadruple-play-v0": dict(alpha=0.3, train_steps=1000000),
    "scene-play-v0":          dict(alpha=0.3, train_steps=1000000),
    "puzzle-3x3-play-v0":     dict(alpha=0.3, train_steps=1000000),
    "puzzle-4x4-play-v0":     dict(alpha=0.3, train_steps=1000000),
