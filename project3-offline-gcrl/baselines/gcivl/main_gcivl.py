...
def main():
    ...
    parser.add_argument('--seed-id',     default=None, type=int,
                        help='Run a single specific seed index instead of 0..seeds-1')
    ...
    seeds       = [args.seed_id] if args.seed_id is not None else list(range(args.seeds))
