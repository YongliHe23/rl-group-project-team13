#!/bin/bash
# Submit 4 parallel GCIVL jobs for powderworld-easy-play, one per seed.
# Usage: bash submit_gcivl_powderworld.sh
...
for seed in 0 1 2 3; do
  ...
  sbatch --job-name="gcivl-powderworld-easy-s${seed}" \
         --mem=32G \
